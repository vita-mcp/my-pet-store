#!/usr/bin/env node
/**
 * MCP Server generated from OpenAPI spec for my-pet-store v1.0.0
 * Generated on: 2025-10-25T15:56:26.457Z
 */
 ...
 */
export const SERVER_NAME = "my-pet-store";
...
// Set up Web Server transport
  try {
    await setupWebServer(server, 3031);
  } catch (error) {
